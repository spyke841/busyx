...
<section class="container">
  <article class="row">
    <div class="col-md-12">
      <div class="contenu">
          <p class="txt-center">
            <label for="mb_id">Choisissez une marque blanche à promouvoir :</label> <select name="mb_id" id="mb_id" size="1"><option value="0">?</option><option selected="" value="2981">sexshop.stocksexy.com</option><option value="14424">so-sexy.com</option></select>
          </p>
          <p class="txt-center">
              <a href="#">Toutes</a> | <a href="#">Générique</a> | <a href="#">Femmes</a> | <a href="#">Chaussures</a> | <a href="#">Bijoux</a> | <a href="#">Bazar sexy</a> | <a href="#">SexShop</a> | <a href="#">Fetish-SM</a>
          </p>
          <p class="txt-center">
            ...
            <select class="select" name="format" id="format">
                ...
                <option>90x60</option>
                <option>90x66</option>
                <option>100x30</option>
                <option>100x60</option>
                <option>100x100</option>
                <option>100x150</option>
                <option>100x200</option>
                <option>100x300</option>
                <option>120x60</option>
                <option>120x120</option>
                <option>120x300</option>
                <option>120x400</option>
                <option>120x450</option>
                <option>120x600</option>
                <option>128x101</option>
                <option>136x107</option>
                <option>150x225</option>
                <option>160x300</option>
                <option>160x600</option>
                <option>230x60</option>
                <option>250x250</option>
                <option>300x250</option>
                <option>300x300</option>
                <option>320x180</option>
                <option>400x400</option>
                <option>468x30</option>
                <option>468x60</option>
                <option>480x150</option>
                <option>500x225</option>
                <option>728x90</option>
                <option>739x208</option>
                <option>926x114</option>
                <option>950x270</option>
            </select>
          </p>
      </div>
    </div>
  </article>
  <div class="col-md-12 marge-down">
    <figure>
      ...
      <figcaption class="txt-right">
        ...
        <div id="code_0" class="code cacher">
        <span class="cacher alert_msg_copy msg_0"></span>
        <span class="help_copy">copier le code <i class="fa fa-caret-right"></i></span>
        <button class="code_to_copy" rel="msg_0" id="target-to-copy_0" data-clipboard-target="clipboard-text_0" type="button_2" name="button" alt="copier le code" title="copier le code"><i class="fa fa-clipboard"></i></button>
          <pre class="txt-left pre">
            <code class="html" id="clipboard-text_0"><?= htmlspecialchars('<a href="http://sexshop.stocksexy.com/" target="_blank">'."\n\t".'<img src="http://images.netcomvad.com/spb/soldesEte2015/950x270.jpg" width="950" height="270">'."\n".'</a>') ?></code>
        </div>
      </figcaption>
    </figure>
  </div>
  ...
  <div class="col-md-12 marge-down">
    <figure>
      ...
      <figcaption class="txt-right">
        ...
        <div id="code_1" class="code cacher">
        <span class="cacher alert_msg_copy msg_1"></span>
        <span class="help_copy">copier le code <i class="fa fa-caret-right"></i></span>
  ...
  <div class="col-md-12 marge-down">
    <figure>
      <figcaption class="txt-center">Taille : 728 x 90</figcaption>
      <img class="img-responsive center-block marge-down" src="http://images.netcomvad.com/spb/soldesEte2015/728x90.jpg">
      <figcaption class="txt-right">
        <button class="view_code" type="button" name="button" rel="code_2">Voir le code <i class="fa fa-caret-down"></i></button>
        <div id="code_2" class="code cacher">
        <span class="cacher alert_msg_copy msg_2"></span>
        <span class="help_copy">copier le code <i class="fa fa-caret-right"></i></span>
        <button class="code_to_copy" rel="msg_2" id="target-to-copy_2" data-clipboard-target="clipboard-text_2" type="button" name="button" alt="copier le code" title="copier le code"><i class="fa fa-clipboard"></i></button>
          <pre class="txt-left pre">
            <code class="html" id="clipboard-text_2"><?= htmlspecialchars('<a href="http://sexshop.stocksexy.com/" target="_blank">'."\n\t".'<img src="http://images.netcomvad.com/spb/soldesEte2015/728x90.jpg" width="728" height="90">'."\n".'</a>') ?></code>
          </pre>
        </div>
      </figcaption>
    </figure>
  ...
  <div class="col-md-12 marge-down">
    <figure>
      <figcaption class="txt-center">Taille : 480 x 150</figcaption>
      <img class="img-responsive center-block marge-down" src="http://images.netcomvad.com/spb/soldesEte2015/480x150.jpg">
      <figcaption class="txt-right">
        <button class="view_code" type="button" name="button" rel="code_3">Voir le code <i class="fa fa-caret-down"></i></button>
        <div id="code_3" class="code cacher">
        <span class="cacher alert_msg_copy msg_3"></span>
        <span class="help_copy">copier le code <i class="fa fa-caret-right"></i></span>
        <button class="code_to_copy" rel="msg_3" id="target-to-copy_3" data-clipboard-target="clipboard-text_3" type="button" name="button" alt="copier le code" title="copier le code"><i class="fa fa-clipboard"></i></button>
          <pre class="txt-left pre">
            <code class="html" id="clipboard-text_3"><?= htmlspecialchars('<a href="http://sexshop.stocksexy.com/" target="_blank">'."\n\t".'<img src="http://images.netcomvad.com/spb/soldesEte2015/480x150.jpg" width="480" height="150">'."\n".'</a>') ?></code>
          </pre>
        </div>
      </figcaption>
    </figure>
